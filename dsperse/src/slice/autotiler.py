...
def apply_tiling_to_slices(slices_dir: str | Path, tile_size: int = 16) -> dict:
    """
    ...
    2. Inject split ops into preceding bridges, concat ops into following bridges
    3. Create tile.onnx for each tileable Conv
