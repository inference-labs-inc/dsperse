...
class Slicer:
    ...
    def slice_model(self, output_path: Optional[str] = None, output_type: str = "dirs", tile_size: Optional[int] = None, parallel: bool = False):
        """
        ...
        result = self.slicer_impl.slice_model(output_path=output_path, tile_size=tile_size, parallel=parallel)
