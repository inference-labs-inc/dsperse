...
class Utils:
        ...
        try:
            ...
            if model_metadata:
                try:
                    ...
                    model = Utils.apply_metadata_shapes(model, model_metadata)
    ...
    def apply_metadata_shapes(model, model_metadata: dict):
        ...
        try:
            ...
            original_shapes = Utils._get_original_model_shapes(model_metadata)
    ...
    @staticmethod
    def write_output(tensor: torch.Tensor, file_path):
    ...
    @staticmethod
    def read_output(file_path) -> torch.Tensor:
